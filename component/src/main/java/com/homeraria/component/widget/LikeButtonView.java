...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    private boolean isChecked, isAnimating = false;
    ...
    public void onClick(View v) {
        ...
        isAnimating = true;
        isChecked = !isChecked;
        ivStar.setImageResource(isChecked ? R.mipmap.ic_thumb_on : R.mipmap.ic_thumb_off);
...
//                    ivStar.setScaleY(0);
                    ...
                    ObjectAnimator starScaleYAnimator = ObjectAnimator.ofFloat(ivStar, ImageView.SCALE_Y, 1f, 0.2f, 1f);
                    starScaleYAnimator.setDuration(300);
                    starScaleYAnimator.setStartDelay(0);
                    starScaleYAnimator.setInterpolator(new AccelerateDecelerateInterpolator());

                    ObjectAnimator starScaleXAnimator = ObjectAnimator.ofFloat(ivStar, ImageView.SCALE_X, 1f, 0.2f, 1f);
                    ...
                    endSet.playTogether(starScaleXAnimator, starScaleYAnimator);
                    endSet.start();
