 ...
 * Phenas项目呼吸效果演示
 */
public class a15Activity extends FragmentActivity
{
    ...
    //保存每个page的信息
    List<a15Activity.PageModel> mPageModelList = new ArrayList<>();

    {
        mPageModelList.add(new a15Activity.PageModel("点线loading", R.layout.phantom_loading));
        mPageModelList.add(new a15Activity.PageModel("圆环切换", R.layout.phantom_switch));
    }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mPager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager())
        {
            ...
            {
                a15Activity.PageModel pageModel = mPageModelList.get(position);
