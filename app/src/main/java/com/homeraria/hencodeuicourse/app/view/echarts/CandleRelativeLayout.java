...
//    private Context mContext;
    ...
    public CandleRelativeLayout(Context context) {
        super(context);
//        mContext = context;
    }

    public CandleRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CandleRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CandleRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        dialog.setMessage("玩儿命加载中...");
    ...
    public void onClick(View v) {
        mWebView.loadUrl("javascript:createChart('aaa','');");
    }
    ...
    private void webViewInitial(WebView webView) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                Log.v("webview", error.getDescription().toString());
