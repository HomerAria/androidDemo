 ...
 */
public class ParticleView extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    ...
    private List<CircleParticle> mCircles = new ArrayList<>();
            ...
            try {
                ...
                if (mCanvas != null) {
                    synchronized (mHolder) {
                        ...
                        for (CircleParticle circle : mCircles) {
